            ...
            <div className="mb-8">
                {isFormOpen ? (
                    <div className="bg-white p-6 rounded-2xl shadow-lg border-2 border-blue-400">
                        ...
                        <textarea placeholder="Descrizione dell'attività (opzionale)..." className="w-full p-4 border rounded-xl mb-4 bg-slate-50 min-h-[100px]" value={descrizione} onChange={(e) => setDescrizione(e.target.value)} />
                        ...
                        <div key={item.id} className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                            ...
                            {isExpanded && (
                                <div className="px-5 pb-5 animate-in slide-in-from-top-2 duration-200">
                                    ...
                                    {/* FIX ALLINEAMENTO: Usiamo grid-cols-2 e items-start */}
                                    <div className="grid grid-cols-2 gap-4 items-start">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <div className="min-h-[14px]">
                                                {votiGiu.length > 0 && (
                                                    <p className="text-[10px] text-slate-400 italic pl-1 leading-tight">

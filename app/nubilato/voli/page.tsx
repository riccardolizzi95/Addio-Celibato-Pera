...
export default function NubilatoVoliPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-slate-50 text-slate-900 text-center">
      <div className="w-full max-w-sm">
        <span className="text-8xl mb-6 block animate-pulse">✈️</span>
        <h1 className="text-4xl font-black mb-2 tracking-tight">Voli & Logistica</h1>

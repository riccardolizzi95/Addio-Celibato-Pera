    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-md mx-auto bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
        ...
        <div className="space-y-6">
          <div>
            <label className="text-sm font-semibold text-slate-500">Nome Visualizzato</label>
            <input 
              type="text" value={username} 
              onChange={(e) => setUsername(e.target.value)}
              className="w-full p-4 border rounded-2xl bg-slate-50 mt-1 outline-none focus:ring-2 ring-blue-500"
            />
          </div>

          <div>
            <label className="text-sm font-semibold text-slate-500">Nuova Password (lascia vuoto se non vuoi cambiarla)</label>
            <input 
